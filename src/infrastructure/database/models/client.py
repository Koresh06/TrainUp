...
from sqlalchemy import ForeignKey, BigInteger, Integer, VARCHAR, Boolean, String
...
class ClientModel(BaseModel, CreatedAtMixin, UpdatedAtMixin):
    ...
    health_notes: Mapped[str | None] = mapped_column(VARCHAR(255), nullable=True)
    injuries: Mapped[str | None] = mapped_column(VARCHAR(255), nullable=True)
    ...
    def update_model(self, entity: "Client") -> None:
        ...
        self.is_registered = entity.is_registered
